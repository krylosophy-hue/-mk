...
const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: 'Объём предоставляемой информации для оформления допуска через автоматизированную систему не отличается от объёма информации, предоставляемой в действующем порядке, отличие в том, что информация будет предоставляться в электронном виде.',
  },
  {

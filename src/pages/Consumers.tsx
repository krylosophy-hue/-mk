          ...
          <div className="flex-1">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                {/* Содержание — по замечанию Хайрутдиновой (обращение 28179) */}
                <Accordion title="Проектно-сметные работы" defaultOpen={false}>
                  <div className="space-y-4">
                    <p className="font-semibold text-[#0a1628]">Выберите вид услуги:</p>

                    <div className="p-5 bg-white rounded-xl border border-gray-200 space-y-3">
                      <p className="font-semibold text-[#0a1628]">Подготовка проектно-сметной документации на прокладку кабельных линий в коллекторах Общества</p>
                      <div className="space-y-2 text-gray-700 text-sm">
                        <p><strong>Сроки оказания услуги:</strong> 10 рабочих дней с момента оплаты счёта.</p>
                        <p><strong>Об услуге:</strong> проектирование осуществляется согласно существующих норм и правил на строительство по г. Москве.</p>
                        <div>
                          <p className="font-semibold text-[#0a1628] mb-1.5">Что получает потребитель услуги:</p>
                          <ul className="space-y-1">
                            <li>— решение ряда проблем, с которыми сталкивается организация, выполняя работы по проектированию прокладки инженерных коммуникаций на объектах коллекторного хозяйства;</li>
                            <li>— проектно-сметную документацию по ценам ниже рыночных;</li>
                            <li>— сокращение сроков проектирования и согласования в 2 раза;</li>
                            <li>— исключение необходимости получения допуска и оформления списков ФСО на объекты коллекторного хозяйства для проведения предпроектного обследования.</li>
                          </ul>
                        </div>
                    ...
                    <div className="p-5 bg-white rounded-xl border border-gray-200 space-y-3">
                      <p className="font-semibold text-[#0a1628]">Подготовка проектно-сметной документации на демонтаж кабельных линий в коллекторах Общества</p>
                      <div className="space-y-2 text-gray-700 text-sm">
                        <p><strong>Сроки оказания услуги:</strong> 10 рабочих дней с момента оплаты счёта.</p>
                        <p><strong>Об услуге:</strong> проектирование осуществляется согласно существующих норм и правил на строительство по г. Москве.</p>
                        <div>
                          <p className="font-semibold text-[#0a1628] mb-1.5">Что получает потребитель услуги:</p>
                          <ul className="space-y-1">
                            <li>— решение ряда проблем, с которыми сталкивается организация, выполняя работы по проектированию демонтажа инженерных коммуникаций на объектах коллекторного хозяйства;</li>
                            <li>— проектно-сметную документацию по ценам ниже рыночных;</li>
                            <li>— сокращение сроков проектирования и согласования в 2 раза;</li>
                            <li>— исключение необходимости получения допуска и оформления списков ФСО на объекты коллекторного хозяйства для проведения предпроектного обследования.</li>
                          </ul>
                        </div>
                        <p><strong>Куда обратиться для получения услуги:</strong> Центр обслуживания потребителей АО&nbsp;«Москоллектор» с письмом-заявкой по разработанной Форме 48 с приложением ТЗ (технического задания) по Форме 10.6.</p>
                        <p>По вопросам, связанным с предоставлением услуги, обращаться по телефону: <a href="tel:+74992222201" className="text-[#0ea5e9] font-semibold">+7 (499) 222-22-01, доб. 3430</a>.</p>
                      </div>
                      <div className="flex flex-wrap gap-2 pt-1">
                        <DownloadButton file="Форма-48.doc" label="Форма 48" />

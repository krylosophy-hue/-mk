                  ...
                  <div className="p-5 bg-white rounded-xl border border-gray-200 space-y-4">
                    ...
                    <div>
                      ...
                      <ul className="space-y-1.5 text-gray-600 text-sm">
                        <li>• Разработка проектной документации на прокладку/врезку/демонтаж кабельных линий и трубопроводов в коллекторах</li>
                        <li>• Разработка сметной документации в соответствии с действующими расценками</li>
                        <li>• Согласование ПСД и проектов производства работ (ППР) в АО «Москоллектор»</li>
                      </ul>
                    </div>
                    ...
                    <table className="w-full min-w-[620px] text-sm">
                      ...
                      <tbody className="divide-y divide-gray-200">
                        {[
                          ...
                          ['29', 'Выдача дубликата акта о выполнении работ по прокладке/демонтажу инженерных коммуникаций, акта приемки-передачи инженерных коммуникаций', '1 шт.', '1 984,31', '2 420,86'],
                          ['30', 'Выдача дубликата акта инвентаризации коммуникаций', '1 шт.', '1 466,98', '1 789,72'],
                          ...
                          ['40', 'Предоставление отчета по протяженности коммуникаций по договору на услуги по технической эксплуатации коллекторов (за 1 000 п. м)', '1 шт.', '1 871,46', '2 283,18'],

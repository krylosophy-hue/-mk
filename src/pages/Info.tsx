...
import { fileUrl, mediaUrl } from '@/lib/utils';
import { documentsRevocation } from '@/lib/content';
            ...
            >
              ...
              <Accordion title="Реквизиты организации">
                <div className="space-y-3 text-slate-600">
                  ...
                  <p><span className="font-medium text-[#0a1628]">Расчётный счёт:</span> 40702810800000004512 в ПАО СБЕРБАНК РОССИИ</p>
...
<Accordion title="Отчёт о реализации мероприятий плана противодействия коррупции в АО «Москоллектор»" defaultOpen>
  <Accordion title="Отчёт о реализации мероприятий плана противодействия коррупции в  АО «Москоллектор» по итогам 2026 года" >
    <div className="space-y-3 text-slate-600">
              ...
              <p>В Обществе действует коллективный договор между работодателем в лице генерального директора и профсоюзным комитетом, представляющим интересы работников. Договор является основой системы мотивации персонала на честный и высокопрофессиональный труд. Обязательства по коллективному договору выполняются в полном объёме;</p>
                ...
                <Accordion title="Памятка по антитеррористической безопасности">
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div className="p-5 bg-white rounded-xl border border-slate-200">
                      ...
                      <p className="text-sm text-slate-600 leading-relaxed">Обращайте внимание на людей с объёмными предметами под одеждой, нервное поведение.</p>
                    </div>
                    <div className="p-5 bg-white rounded-xl border border-slate-200">
            ...
            >
              ...
              <div className="card-modern rounded-2xl p-7 mb-6">
                ...
                {/* Список — из CMS (коллекция «Отзыв доверенностей», /admin/).
                    Ранее хардкод содержал баг '${doc.file}' в кавычках — все ссылки 404. */}
                <div className="space-y-3">
                  {documentsRevocation.map((doc) => (
                    <a
                      key={doc.id}
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="font-medium text-[#0a1628] truncate">{doc.title}</p>

          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
              ...
              <motion.p variants={fadeIn} className="text-gray-500 text-[16px] leading-relaxed mb-5">
                ...
                в котором проложены силовые кабели, линии связи и спецсвязи, трубопроводы
                систем теплоснабжения, отопления, горячего и холодного водоснабжения.
                Специалисты компании обеспечивают безопасность и надлежащие условия для
                бесперебойной работы этих инженерных сетей, а также осуществляют технический
                надзор при строительстве новых и модернизации существующих коллекторов.
              </motion.p>
              <motion.p variants={fadeIn} className="text-gray-400 leading-relaxed mb-8">
                Территория Москвы разделена на шесть районов эксплуатации коллекторов (РЭК).
                Кроме того, действует специализированное управление по эксплуатации
                коммуникационных коллекторов г. Зеленограда.
              </motion.p>

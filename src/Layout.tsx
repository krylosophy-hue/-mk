...
const formCatalog: SearchItem[] = [
  ...
  { title: 'Форма 12 — продление ТУ', file: FORMS_BASE + 'ФОРМА-12.xlsx', path: '/consumers#commercial', keywords: 'форма 12 продление ту согласование проект', isForm: true },
  ...
  { title: 'Форма 27(П) — заказчик/проектная (охранная зона)', file: FORMS_BASE + 'форма-27П.doc', path: '/consumers#work', keywords: 'форма 27 27п охранная зона проектная заказчик инвестор', isForm: true },
  { title: 'Форма 27(З) — заявка на работы в ОЗ', file: FORMS_BASE + 'форма-27З.doc', path: '/consumers#work', keywords: 'форма 27 27з охранная зона заявка', isForm: true },
  // ===== Допуск (30-серия) =====
  ...
  { title: 'Форма 58 — заявка на ОВК (демонтаж/перекладка)', file: FORMS_BASE + 'ФОРМА-58.docx', path: '/consumers#work', keywords: 'форма 58 овк оптоволокно демонтаж перекладка горзаказ', isForm: true },
  ...
  // ===== Типовые договоры =====
  // «Договор на сохранность» — это Форма 15 / 15.1 (есть в каталоге выше).
  // Прежние записи ОПС/физлица/юрлица вели на несуществующие файлы (404) — убраны.
  { title: 'Форма 15.1 — договор на сохранность (охранные зоны)', file: FORMS_BASE + 'Форма-15.1.doc', path: '/consumers#contracts', keywords: 'форма 15.1 договор сохранность охранная зона коллектор', isForm: true },
